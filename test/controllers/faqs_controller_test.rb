...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post faqs_url, params: { faq: { answer: @faq.answer, group_id: @faq.group_id, question: @faq.question } }
    end
  ...
  test "should update faq" do
    patch faq_url(@faq), params: { faq: { answer: @faq.answer, group_id: @faq.group_id, question: @faq.question } }
